...
- 1.0.03
	- Устранен баг с отрицательной мощностью.
- 1.0.04
	- Устранен потенциальный (возможный, но не 100% :)) потери накопленой мощности при отключении питания.
